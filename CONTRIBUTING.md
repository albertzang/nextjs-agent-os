...
6. Publish **`@nextjs-agent-os/cli@0.0.N`** to npm.

**Self-evolve:** CEO kickoff → `feature-branch` loop on this repo only; clients consume via `npx @nextjs-agent-os/cli upgrade`.
